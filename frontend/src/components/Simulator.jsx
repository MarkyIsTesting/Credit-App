...
const TYPES = [
  { id: "personnel", label: "Prêt personnel" },
  { id: "immobilier", label: "Prêt immobilier" },
  { id: "auto", label: "Crédit auto" },
  { id: "professionnel", label: "Prêt professionnel" },
      ...
      <div className="relative mx-auto max-w-[1600px] px-6 md:px-12">
        <div className="grid md:grid-cols-12 gap-8 mb-14 md:mb-20">
          ...
          <h2 className="md:col-span-8 font-serif text-4xl md:text-6xl text-white leading-[1.02] tracking-tighter">
            Chiffrez vos ambitions en{" "}
            <span className="italic text-[#D4AF37]">trois gestes</span>.
          </h2>
        </div>
        ...
        <div className="grid md:grid-cols-12 gap-10 md:gap-16">
          ...
          <div className="md:col-span-6 space-y-14">
                ...
                <SelectContent className="bg-[#0A0A0A] border border-white/10 text-white">
                  {TYPES.map((t) => (
                    <SelectItem
                      key={t.id}
                      value={t.id}
                      data-testid={`simulator-type-${t.id}`}
            ...
            <div>
              <div className="flex items-baseline justify-between mb-6">
                ...
                <span
                  ...
                  data-testid="simulator-amount-value"
                >
                  {formatEUR(amount)}
                </span>
              </div>
            ...
            <div>
              <div className="flex items-baseline justify-between mb-6">
                ...
                <span
                  className="font-serif text-3xl md:text-4xl text-white"
                  data-testid="simulator-duration-value"
                >
                  {months} mois
                </span>
              </div>
          ...
          >
            ...
            <div className="mt-12 grid grid-cols-2 gap-8 border-t border-white/10 pt-8">
              <div>
                ...
                <p
                  ...
                  data-testid="simulator-total-cost"
                >
                  {formatEUR(totalCost)}
                </p>
              </div>
              <div>
                ...
                <p
                  className="font-serif text-2xl md:text-3xl text-[#D4AF37]"
                  data-testid="simulator-total-interest"
                >
            ...
            <p className="text-[10px] text-white/30 mt-6 leading-relaxed">
              Estimation indicative — hors assurance et frais de dossier. Un
              crédit vous engage et doit être remboursé. Vérifiez vos capacités
